					...
					<div class="row mt--2">
						...
						<div class="col-md-3">
							<div class="card card-stats card-danger card-round">
								...
								<div class="card-body">
									<a href="javascript:void(0)" id="activeCase" class="card-link text-light">Active Appointment </a>
								</div>
							</div>
							<div class="card card-stats card-success card-round">
								...
								<div class="card-body">
									<a href="javascript:void(0)" id="settledCase" class="card-link text-light">Finished Appointment </a>
								</div>
							</div>
							<div class="card card-stats card-warning card-round">
								...
								<div class="card-body">
									<a href="javascript:void(0)" id="scheduledCase" class="card-link text-light">Scheduled Appointment </a>
								</div>
							</div>
						</div>
					</div>
