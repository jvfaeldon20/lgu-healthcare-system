                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="national" placeholder="Enter Philhealth ID No." required>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label>Philhealth ID No.</label>
                                        <input type="text" class="form-control" name="national" id="nat_id" placeholder="Enter Philhealth ID No.">
                                    </div>
                                    <div class="form-group">
                                        <label>Citizenship</label>
